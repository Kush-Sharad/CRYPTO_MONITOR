● It is a web application that enables the user to track the real time price of various crypto currencies. This website uses the data from the CoinAPI integrated using Axios.
